                                ...
                                child: Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final containerDashboardResponse =
                                          snapshot.data!;
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  _model.apiResultbro =
                                                      await CreateScheduleOneClickCall
                                                          .call(
                                                    token: FFAppState().token,
                                                  );

                                                  if ((_model.apiResultbro
                                                          ?.succeeded ??
                                                      true)) {
                                                    FFAppState().token =
                                                        valueOrDefault<String>(
                                                      CreateScheduleOneClickCall
                                                          .message(
                                                        (_model.apiResultbro
                                                                ?.jsonBody ??
                                                            ''),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                options: FFButtonOptions(
                                  ...
                                  hoverTextColor: const Color(0xFFEA0F0F),
                                ),
                              ),
                            ),
                          ],
